...
fun TemperatureChart(
    ...
    // 2. Constants
    val leftAxisSpace = 40.dp
    val bottomAxisSpace = 30.dp
    val topPadding = 16.dp
    val baseHourWidth = 100.dp // Width for 1 hour at scale 1.0
    ...
    Box(
        modifier = modifier
            ...
            .pointerInput(Unit) {
                // Tell parent (Pager) not to steal swipes when we start dragging
