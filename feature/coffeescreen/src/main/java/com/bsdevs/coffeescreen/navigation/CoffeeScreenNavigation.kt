...
@Serializable
data class CoffeeDetailScreenRoute(val coffeeDetail: CoffeeDto)
...
fun NavGraphBuilder.coffeeScreenSection(
    ...
    navigation<CoffeeScreenBaseRoute>(startDestination = CoffeeHomeScreenRoute) {
        ...
        composable<CoffeeDetailScreenRoute>(typeMap = mapOf(typeOf<CoffeeDto>() to CoffeeDtoType)) { backStackEntry ->
